                ...
                <div className="space-y-24">
                    ...
                    <section>
                        ...
                        <p className="text-neutral-900/70 leading-[1.7] text-[16px] md:text-[17px]">
                            Archit Associates is a New Delhi-based supplier of premium industrial spares, laboratory testing equipment, and precision instruments. We serve infrastructure, construction, and manufacturing industries across India, delivering equipment that meets the highest standards of quality and performance.
                        </p>
                    </section>
